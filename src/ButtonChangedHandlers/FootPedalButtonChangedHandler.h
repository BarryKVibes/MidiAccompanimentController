/*******************************************************************************
  FootPedalButtonChangedHandler.h
...
#ifndef FootPedalButtonChangedHandler_H
#define FootPedalButtonChangedHandler_H
...
class FootPedalButtonChangedHandler : public ButtonChangedHandlerBase
{
public:
  FootPedalButtonChangedHandler();
