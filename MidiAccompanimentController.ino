...
// This file is intentionally left blank in order to support building in both Arduino IDE (requires .ino file at root), and PlatformIO IDE (main.cpp in src).
// The setup() and loop() functions are in main.cpp.
